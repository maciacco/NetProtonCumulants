...
const char* obs_ax_2[]{"#it{#kappa}_{6}(p - #bar{p})/#it{#kappa}_{2}(p - #bar{p})", "#it{#kappa}_{4}(p - #bar{p})/#it{#kappa}_{2}(p - #bar{p})",
"#it{#kappa}_{2}(p - #bar{p})/#LTp + #bar{p}#GT", "#it{#kappa}_{2}(#bar{p})/#it{#kappa}_{1}(#bar{p})", "#it{#kappa}_{3}(#bar{p})/#it{#kappa}_{1}(#bar{p})",
"[#it{#kappa}_{2}(p - #bar{p}) - #LTp + #bar{p}#GT]/#LTp + #bar{p}#GT^{2}"};
