...
const char *kResDir = "/data/mciacco/NetProtonCumulants/results";
...
// systematics vars
constexpr int kNVar = 50;
constexpr int kVar[kNVar + 1] = {0, 15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195, 210, 225, 240, 255, 270, 285, 300, 315, 330, 345, 360, 364, 375, 390, 405, 420, 435, 450, 465, 480, 495, 510, 525, 540, 555, 570, 585, 600, 615, 630, 645, 660, 675, 690, 705, 728};
